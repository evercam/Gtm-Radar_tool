...
export const API_LIMITS: ApiLimit[] = [
  ...
  },
  {
    ...
    requestsPerMinute: null,
    verified: false,
    note: 'Not checked. 100 is what our adapter assumes.',
  },
  {
    slugs: ['world-bank'],
    ...
    requestsPerMinute: null,
    verified: false,
    note: 'Not checked, and 20 a request is low enough to look like a mistake rather than a limit. Worth an hour with their documentation.',
  },
  {
    slugs: ['planning-ie'],
    ...
    requestsPerMinute: null,
    verified: false,
    note: 'Not checked. An ArcGIS service publishes its own maxRecordCount, which is worth reading rather than assuming.',
  },
  {
